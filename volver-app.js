...
(function(){
  ...
  Object.assign(I18N_STATIC.es, {
    ...
    sv_s3_p2: 'También fue el nombre de una canción de João Manô — y fue esa canción la que inspiró el nombre de esta plataforma. En ella, el regreso no se trata de huir del presente, se trata de volver a él: soltar el peso que la vida va acumulando — recuerdos, identidades prestadas, el exceso del día a día — para reencontrar un lugar más simple y verdadero, de presencia y fe. Es ese mismo movimiento el que Volver propone: no una huida de la vida real, sino un regreso constante a ella, con la mente renovada por la Palabra.',
